...
melo_webplayer_init (MeloWebPlayer *self)
{
  ...
  /* Override cover URL for playlist: MeloTags generated by browsers can
   * contain a cover URL which has a reference to an external URL.
   */
  melo_playlist_simple_override_cover_url (
                                          MELO_PLAYLIST_SIMPLE (priv->playlist),
                                          TRUE);
}
